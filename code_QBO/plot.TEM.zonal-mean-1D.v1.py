...
if host == 'nersc':
    ...
    tmp_sub = 'tem'
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8',           n='E3SM control',   clr='black',   p=tmp_scratch, s=tmp_sub)
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_55', n='E3SM top_km_55', clr='red',     p=tmp_scratch, s=tmp_sub)
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_50', n='E3SM top_km_50', clr='orange',  p=tmp_scratch, s=tmp_sub)
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_45', n='E3SM top_km_45', clr='yellow',  p=tmp_scratch, s=tmp_sub)
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_40', n='E3SM top_km_40', clr='green',   p=tmp_scratch, s=tmp_sub)
    add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_35', n='E3SM top_km_35', clr='blue',    p=tmp_scratch, s=tmp_sub)
    # add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_30', n='E3SM top_km_30', clr='purple',  p=tmp_scratch, s=tmp_sub)
    # add_case('E3SM.2026-model-top-test-00.ne30pg2.F20TR.NN_8.top_km_25', n='E3SM top_km_25', p=tmp_scratch, s='run')
    htype = 'eam.h0'
    yr1, yr2 = 1995, 1999
    month_list = [7] # 1 / 7

    add_var('u',         plev=20, str='20mb U [m/s]')
    add_var('utendepfd', plev=20, str='20mb EPFD')

    add_var('u',         plev=50, str='50mb U [m/s]')
    add_var('utendepfd', plev=50, str='50mb EPFD')
...
fig_file      = 'figs_QBO/TEM.zonal-mean-1D.v1.png'
tmp_file_head = 'TEM.zonal-mean-1D.v1'
    ...
    for c in range(num_case):
        ...
        if recalculate:
            ...
            if var_opts_list[v].get('plev'):
                ...
                target_plev_mb = [float(var_opts_list[v].get('plev'))]
                if 'lev' in ds.dims:
                    ...
                    data = ds[var[v]].sel(plev=target_plev_mb).isel(plev=0)
            else:
                data = ds[var[v]]
            #-------------------------------------------------------------------
            # adjust units
        ...
        lat_list.append(data.lat.values)
